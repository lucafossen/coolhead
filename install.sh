...
import json
presets = {
    "quiet":       [[0,0,65],[1,63,70],[2,68,76],[3,74,82],[4,80,87],[5,85,91],[7,89,999]],
    "balanced":    [[0,0,60],[1,58,66],[2,64,72],[3,70,78],[4,76,84],[5,82,88],[7,86,999]],
    "performance": [[0,0,50],[1,48,55],[2,53,62],[3,60,68],[4,66,74],[5,72,78],[7,76,999]],
}
